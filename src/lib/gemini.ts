...
### 4막 구조 (각 막 2-4개 대사)
1. 훅 (Hook): 시청자가 1초 안에 멈추게 하는 충격적 첫 대사
2. 전개 (Development): 상황 설명, 대립 구도 형성, 코미디 에스컬레이션
3. 클라이맥스 (Climax): 한국 활약/반전, 웃음 포인트 최대화, 코리아 플렉스
4. 아웃트로 (Outro): 외국 반응 (혼잣말 활용!), 따뜻한/통쾌한 마무리
